...
2. **Pre-train GCNN:**
   - Train GCNN on large molecular databases (e.g., ZINC, ChEMBL) using graph-based representations.
   - Alternatively, use a pre-existing pre-trained model.
3. **Fine-tune GCNN:**
...
# Sub Features to be Implemented
...
## 2. Addressing Noise with Clustering on the New Scraped Dataset
### What It Is:
...
### Methods:
- Use **Balanced Random Forest**, **RUSBoost**, or **SMOTE**.
...
## 5. Train and Test Different Models (e.g., LGBM) and Perform SHAP Analysis
### Implementation Steps:
1. **Train Model:**
...
# Experimental Implementations (Require a Lot of Domain Knowledge and Understanding of Maths and Probability)

## 1. Incorporating Physics-Based Models
### What It Is:
